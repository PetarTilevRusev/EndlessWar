...
--[[
  ...
  PrecacheUnitByNameSync("undead_melee_guard", context)
  PrecacheUnitByNameSync("undead_ranged_guard", context)
  ...
  PrecacheUnitByNameSync("banshee", context)
  PrecacheUnitByNameSync("banshee_4", context)
  PrecacheUnitByNameSync("necromancer", context)
  PrecacheUnitByNameSync("necromancer_4", context)
  PrecacheUnitByNameSync("necromancer_melee_skeleton_4", context)
  PrecacheUnitByNameSync("necromancer_ranged_skeleton_4", context)
    -- Undead buildings
