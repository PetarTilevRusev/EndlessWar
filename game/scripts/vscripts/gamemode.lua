...
function GameMode:OnAllPlayersLoaded()
  ...
  table.insert(humanSpawners, Entities:FindByName( nil, "human_mele_spawner_1"):GetAbsOrigin())
...
function GameMode:OnHeroInGame(hero)
  ...
  if team == DOTA_TEAM_GOODGUYS then
    ...
    for _, player in ipairs(humanTeam) do
      ...
      humanBuildings[counter + 1]:SetOwner(player)

      print("The player: "..humanBuildings[counter]:GetPlayerOwnerID().." owns: "..humanBuildings[counter]:GetUnitName())
      print("The player: "..humanBuildings[counter + 1]:GetPlayerOwnerID().." owns: "..humanBuildings[counter + 1]:GetUnitName())
...
function GameMode:OnGameInProgress()
  ...
  local start_after = 30 -- Start this timer *start_after* game-time seconds later
    ...
    Timers:CreateTimer(start_after, function()
        Spawner:SpawnHumanWaves()
        Spawner:SpawnUndeadWaves()
        --Spawner:SpawnNightElfWaves()
        --Spawner:SpawnOrcWaves()
        return repeat_interval
    end)
end
...
function GameMode:InitGameMode()
  ...
  -- Tables that will hold the players for every team
  humanTeam = {}
  undeadTeam = {}
  nightElfTeam = {}
  orcTeam = {}
  ...
  -- Tables thath will hold all the entities locations
  humanSpawners = {}
  undeadSpawners = {}
  nightElfSpawners = {}
  orcSpawners = {}
